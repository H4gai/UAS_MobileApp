...
public class FragmentSatu extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding.rvHasil2.setAdapter(adapter);

        lm = new LinearLayoutManager(getActivity());
        binding.rvHasil2.setLayoutManager(lm);

        //supaya ada garis antar row
        binding.rvHasil2.addItemDecoration(new DividerItemDecoration(getActivity(), LinearLayoutManager.VERTICAL));


        binding.button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                binding.tvKeterangan.setText("Tunggu sebentar");
                ...
                ApiHargaBitcoin.get("advice", null, new JsonHttpResponseHandler() {
                    ...
                    public void onSuccess(int statusCode,
                        ...
                        String rate= null;
                        try {
                            JSONObject bpi = response.getJSONObject("slip"); // 4 adalah "bpi"
                            rate = (String) bpi.get("advice");
                        } catch (JSONException e) {
                            e.printStackTrace();
                            Log.e("debugyudi", "msg error" +":" +e.getMessage());
                        }
                        Log.d("debugyudi", "advice" +":" +rate);
